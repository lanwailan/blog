      ...
      <div class="col-sm-7" style="background:#ffffff;margin-right:20px;padding:15px;">
             <table class="table table-bordered">
                <div class="form-group">
                    <label for="name">编辑文章标题:<span style="color:#f00;"><?php echo form_error('title') ?></span></label>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                     ...
                     <textarea class="form-control" rows="15" name="content"> <?php echo set_value('content') ?></textarea>
             ...
             <div class="col-sm-12" style="background:#ffffff;padding:15px;margin-bottom:5px;">
                 <div class="panel panel-success">
                     ...
                     <div class="panel-footer">
                        <button type="submit" class="btn btn-default">发布更改</button>
                     </div>
                </div>
             </div>
                         ...
                         <ul id="myTab" class="nav nav-tabs">
                          ...
                          <div id="myTabContent" class="tab-content">
                              <div class="tab-pane fade in active" id="allsort">
                                 <select multiple class="form-control" name="sortid" style="height: 120px;">
                                      <option>CI</option>
                                      <option>Essay</option>
                                      <option>PHP</option>
